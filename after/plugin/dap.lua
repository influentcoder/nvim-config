...
vim.keymap.set('n', '<F10>', function() require('dap').step_out() end, { desc = 'DAP - Step Out' })
...
vim.keymap.set('n', '<Leader>du', function() require('dap').up() end, { desc = 'DAP - Up the callstack' })
vim.keymap.set('n', '<Leader>dd', function() require('dap').down() end, { desc = 'DAP - Down the callstack' })
